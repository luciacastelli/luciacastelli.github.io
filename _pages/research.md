...
## Thesis title: "Search For a Glycobiological Signature Potentially Predictive Of The Transition From Ulcerative Colitis (UC) To Colitis-Associated Colorectal Cancer (CACRC)"
...
You can download my Thesis <a href="/files/Castelli_PFI_BIO2025.pdf" download = "Lucia_Castelli_Thesis_SP">here (in Spanish)</a> and <a href="/files/Castelli_PFI_BIO2025_ENG.pdf" download = "Lucia_Castelli_Thesis_ENG">here (English automatic translation)</a>. Slides: <a href="/files/presentation_sp.pdf" download = "Lucia_Castelli_Slides_SP">Spanish</a>, <a href="/files/presentation_eng.pdf" download = "Lucia_Castelli_Slides_ENG">English (automatic translation)</a>. *DISCLAIMER: Seeing as the English versions of these files are machine translated, there might be some insconsistencies. The figures are mostly in Spanish as well. Feel free to reach out should any doubts arise!*
